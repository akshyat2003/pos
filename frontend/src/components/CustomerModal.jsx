    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={e => e.stopPropagation()}>
        <div className="modal-header">
          <h3 style={{ margin: 0, fontSize: '1.15rem' }}>Complete Purchase</h3>
        ...
        <div className="profile-modal-body">
          ...
          <form id="checkout-form" onSubmit={handleSubmit} className="modal-form">
        ...
        <div className="modal-footer">
          <div className="modal-actions" style={{ margin: 0 }}>
            ...
            <button type="submit" form="checkout-form" className="btn-primary" disabled={isProcessing}>{isProcessing ? 'Processing Order...' : `Confirm & Buy ($${cartTotal.toFixed(2)})`}</button>
          </div>
        </div>
      </div>
    </div>
